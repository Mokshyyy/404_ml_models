...
rec_df = df[['propertyType','furnishing','city','carpetAreaUnit','bedrooms','bathrooms','balconies','Swimming_Pool','Reserved_Parking','Club_House','Gymnasium','Kids_Play_Area','Park','Bank__And__ATM']].dropna()
...
rec_df['tags'] = rec_df[['propertyType', 'furnishing' ,'BHK','bath','balcony','city','SP','RP','CH','Gym','KPA','P','A']].agg(', '.join, axis=1)

train_df,test_df = train_test_split(rec_df,test_size=0.5,random_state=42)
# print(rec_df.tags)
input_tag = ["Apartment, Semi-Furnished, 2 BHK, 2 Bathrooms, 1 Balcony, Mumbai, Gym, Park"]
